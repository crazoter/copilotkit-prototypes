...
export default function ToolBasedGenerativeUI({ params }: ToolBasedGenerativeUIProps) {
  ...
  const chatProps = {
    ...
    labels: {
      ...
      initial: "I'm a haiku generator 👋. How can I help you? (Disclaimer, the images are pre-generated by GPT-5-mini)",
    },
  ...
  return (
    <CopilotKit
      runtimeUrl={getAgentRuntimeUrl("haiku_gen")}
...
// Comment: I just used GPT-5-mini to generate images hahahaha
const VALID_IMAGE_NAMES = [
  "Osaka_Castle_Turret_Stone_Wall_Pine_Trees_Daytime.photographic.svg",
  "Tokyo_Skyline_Night_Tokyo_Tower_Mount_Fuji_View.photographic.svg",
  "Itsukushima_Shrine_Miyajima_Floating_Torii_Gate_Sunset_Long_Exposure.photographic.svg",
  "Takachiho_Gorge_Waterfall_River_Lush_Greenery_Japan.photographic.svg",
  "Bonsai_Tree_Potted_Japanese_Art_Green_Foliage.photographic.svg",
  "Shirakawa-go_Gassho-zukuri_Thatched_Roof_Village_Aerial_View.photographic.svg",
  "Ginkaku-ji_Silver_Pavilion_Kyoto_Japanese_Garden_Pond_Reflection.photographic.svg",
  "Senso-ji_Temple_Asakusa_Cherry_Blossoms_Kimono_Umbrella.photographic.svg",
  "Cherry_Blossoms_Sakura_Night_View_City_Lights_Japan.photographic.svg",
  "Mount_Fuji_Lake_Reflection_Cherry_Blossoms_Sakura_Spring.photographic.svg",
];
  ...
  useCopilotAction(
    {
      ...
      parameters: [
        ...
        },
        {
          ...
          type: "string",
          required: true,
          description: `The most relevant image name from: ${VALID_IMAGE_NAMES.join(", ")}`,
        },
        {
          name: "gradient",
          type: "string",
