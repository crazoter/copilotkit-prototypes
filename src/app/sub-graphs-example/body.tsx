...
export default function Subgraphs({ params }: SubgraphsProps) {
  ...
  const initialLabel = 'Hi! ✈️ Ready to plan an amazing trip? (For now, only Amsterdam to San Francisco with no reset)';

  return (
    <CopilotKit
      runtimeUrl={getAgentRuntimeUrl("sub_graphs_example")}
      showDevConsole={false}
      agent="sub_graphs_example"
    >
